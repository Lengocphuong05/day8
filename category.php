...
<body>
    <div class="container mt-3">
        <div>
            ...
            <a href="add_category.php" class="btn btn-success" style="margin-right: 5px;">Create</a>
        </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $value['name'];?></td>
                <td>
                    <form id="delete_<?= $value['id'] ?>" action="delete_category.php" method="POST" style="display:flex">
